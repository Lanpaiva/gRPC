...
type CategoryServiceClient interface {
	...
	CreateCategoryStreamBidirect(ctx context.Context, opts ...grpc.CallOption) (CategoryService_CreateCategoryStreamBidirectClient, error)
...
func (c *categoryServiceClient) CreateCategoryStreamBidirect(ctx context.Context, opts ...grpc.CallOption) (CategoryService_CreateCategoryStreamBidirectClient, error) {
	stream, err := c.cc.NewStream(ctx, &CategoryService_ServiceDesc.Streams[1], "/pb.CategoryService/CreateCategoryStreamBidirect", opts...)
	if err != nil {
		return nil, err
	}
	x := &categoryServiceCreateCategoryStreamBidirectClient{stream}
	return x, nil
}

type CategoryService_CreateCategoryStreamBidirectClient interface {
	Send(*CreateCategoryRequest) error
	Recv() (*Category, error)
	grpc.ClientStream
}

type categoryServiceCreateCategoryStreamBidirectClient struct {
	grpc.ClientStream
}

func (x *categoryServiceCreateCategoryStreamBidirectClient) Send(m *CreateCategoryRequest) error {
	return x.ClientStream.SendMsg(m)
}

func (x *categoryServiceCreateCategoryStreamBidirectClient) Recv() (*Category, error) {
	m := new(Category)
	if err := x.ClientStream.RecvMsg(m); err != nil {
		return nil, err
	}
...
type CategoryServiceServer interface {
	...
	CreateCategoryStreamBidirect(CategoryService_CreateCategoryStreamBidirectServer) error
...
func (UnimplementedCategoryServiceServer) CreateCategoryStreamBidirect(CategoryService_CreateCategoryStreamBidirectServer) error {
	return status.Errorf(codes.Unimplemented, "method CreateCategoryStreamBidirect not implemented")
}
...
func _CategoryService_CreateCategoryStreamBidirect_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(CategoryServiceServer).CreateCategoryStreamBidirect(&categoryServiceCreateCategoryStreamBidirectServer{stream})
}

type CategoryService_CreateCategoryStreamBidirectServer interface {
	Send(*Category) error
	Recv() (*CreateCategoryRequest, error)
	grpc.ServerStream
}

type categoryServiceCreateCategoryStreamBidirectServer struct {
	grpc.ServerStream
}

func (x *categoryServiceCreateCategoryStreamBidirectServer) Send(m *Category) error {
	return x.ServerStream.SendMsg(m)
}

func (x *categoryServiceCreateCategoryStreamBidirectServer) Recv() (*CreateCategoryRequest, error) {
	m := new(CreateCategoryRequest)
	if err := x.ServerStream.RecvMsg(m); err != nil {
		return nil, err
	}
...
var CategoryService_ServiceDesc = grpc.ServiceDesc{
	...
	Streams: []grpc.StreamDesc{
		...
		{
			StreamName:    "CreateCategoryStreamBidirect",
			Handler:       _CategoryService_CreateCategoryStreamBidirect_Handler,
			ServerStreams: true,
			ClientStreams: true,
		},
	},
